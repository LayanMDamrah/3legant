                        ...
                        <div id="editForm" class="account-container hidden">
                            ...
                            <table class="table table-bordered table-hover text-center align-middle">
                                ...
                                <tbody id="users_table_body">
                                    <?php
$editingUserId = isset($_GET['updated_user_id']) ? (int)$_GET['updated_user_id'] : null;
?>

                                    <?php foreach ($users as $user): ?>
                                        <?php $isEditing = ($editingUserId === (int)$user['User_ID']); ?>
                                        <!-- Read-only view -->
                                        ...
                                        <td class="edit" style="display:none;" colspan="6">
                                            <form method="POST" action="admin.php" enctype="multipart/form-data" class="d-flex gap-2 align-items-center">
                                    ...
                                    <tr>
                                        ...
                                        <div id="user-form" class="d-none mt-3">
                                            <form method="POST" action="admin.php" class="d-flex gap-3 align-items-center">
