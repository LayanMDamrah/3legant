...
if (isset($_POST['create_new_user'])) {
    ...
    // Insert user
    Admin::addUsers($name, $email, $age, $role, $hashedPassword, null, $photo, $status);
...
if (isset($_POST['update_user_id'])) {
    ...
    if (!empty($_POST['password'])) {
        ...
        $password = $currentUser['Password']; // Already hashed
    }
    $photo = !empty($_POST['photo']) ? $_POST['photo'] : $currentUser['Photo'];
